...
noise_length=100
batch_size=128
dataset=open('/home/SharedData/yagnesh/CUB/list.txt','r').read().splitlines()
epoch=1
epochs=200000
lam=2.0
...
W_d_bad=tf.reduce_mean(tf.nn.sigmoid_cross_entropy_with_logits(logits=Df,labels=tf.zeros_like(Df)+0.1))
